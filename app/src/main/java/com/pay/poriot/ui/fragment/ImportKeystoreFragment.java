...
public class ImportKeystoreFragment extends BaseFragment implements View.OnClickListener {
    ...
    CleanableEditText mEdtKeystore;
    ...
    private void initViews(View view) {
        ...
        mEdtKeystore.setHint(getString(R.string.enter_keystore));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bt_determine:
                ...
                String keystore = mEdtKeystore.getText().toString().trim();
                if (verifyInfo()) {
    ...
    private boolean verifyInfo() {
        ...
        if (TextUtils.isEmpty(keystore)) {
            showToast(getString(R.string.wallet_keystore_invalid));
            return false;
