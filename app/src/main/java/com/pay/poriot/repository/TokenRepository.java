...
public class TokenRepository implements TokenRepositoryType {
    ...
    private void buildWeb3jClient(NetworkInfo networkInfo) {
        EvtLog.d(networkInfo.rpcServerUrl + " " + networkInfo.rpcServerUrl);
    ...
    public Completable addToken(String walletAddress, String address, String symbol, int decimals) {
        EvtLog.d("addToken:" + walletAddress + ", address: " + address + ", source:" + tokenLocalSource + ", ethereumNetworkRepository:" + ethereumNetworkRepository );
