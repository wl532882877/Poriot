...
import com.pay.poriot.listener.OnNetworkChangeListener;
...
import static com.pay.poriot.config.C.CLASSIC_NETWORK_NAME;
import static com.pay.poriot.config.C.ETC_SYMBOL;
import static com.pay.poriot.config.C.ETHEREUM_MAIN_NETWORK_NAME;
import static com.pay.poriot.config.C.ETH_SYMBOL;
import static com.pay.poriot.config.C.KOVAN_NETWORK_NAME;
import static com.pay.poriot.config.C.LOCAL_DEV_NETWORK_NAME;
import static com.pay.poriot.config.C.POA_NETWORK_NAME;
import static com.pay.poriot.config.C.POA_SYMBOL;
import static com.pay.poriot.config.C.ROPSTEN_NETWORK_NAME;
...
public class EthereumNetworkRepository  {
    ...
    private final NetworkInfo[] NETWORKS = new NetworkInfo[] {
            new NetworkInfo(ETHEREUM_MAIN_NETWORK_NAME, ETH_SYMBOL,
                    "https://mainnet.infura.io/v3/44fd4c78f9824b5bbf44aff180f33afd",
